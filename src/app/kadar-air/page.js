...
const page = () => {
  ...
  return (
    ...
    <form className="flex justify-center flex-col items-center" onSubmit={handleResult}>
      ...
      <FloatingLabel variant="outlined" label="Berat Kosong Petri" ref={checkinput} name="name"value={num} onChange={(e) => setNum(e.target.value)} />
      <FloatingLabel variant="outlined" label="Berat Isi" ref={checkinput} name="name"value={isi} onChange={(e) => setIsi(e.target.value)} />
      <FloatingLabel variant="outlined" label="Berat Total" ref={checkinput} name="name"value={total} onChange={(e) => setTotal(e.target.value)} />
